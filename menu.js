...
const getSizes = () => {
    return Object.keys(feeding_size);
}
const getItems = () => {
    return ['pizza', 'salads', 'drinks', 'desserts']
}

const getToppings = () => {
    return ['mushroom', 'ham', 'tomatoes']
}
const getCrusts = () => {
    return ['regular', 'hand made', 'deep dish', 'gluten free', 'thin crust', 'brooklyn style']
}
const getCheeses = () => {
    return ['normal', 'none', 'light', 'extra', 'double']
}
